...
public class MazeRunner extends Script {
	...
	public void createPath(int x, int y, int z) {
		Location l;
		AStar path = Player.makePath(l = new Location(x, y, z));
		if(path != null) {
			currentPath = Player.getCurrentPath();
